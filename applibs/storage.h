...
extern "C"
{
    ...
    int Storage_Read(int fd, uint8_t *readData, size_t lenReadData);
    int Storage_Write(int fd, uint8_t *writeData, size_t lenWriteData);
    int64_t Storage_Lseek(int fd, uint64_t offset, int whence);
